// This file is extracted from the main repository of the Xamarin.mac with little tweaks.
...
[Native]
public enum IMKCandidatePanelType : ulong {
...
[Native]
public enum IMKStyleType : ulong { Main = 0, Annotation = 1, SubList = 2 }

[Native]
public enum IMKCandidatesLocationHint : ulong {
  Above = 1,
  Below = 2,
  Left = 3,
  Right = 4
...
partial interface IMKGlobal {
  ...
  [Field("kIMKCommandClientName")] NSString CommandClientName { get; }
}
...
partial interface IMKServerProxy {
  ...
  [Field("IMKControllerClass")] NSString ControllerClass { get; }

  [Field("IMKDelegateClass")] NSString DelegateClass { get; }
}
...
partial interface IMKServer : IMKServerProxy {
  ...
  NativeHandle Constructor(string name, Class controllerClassId,
                           Class delegateClassId);

  [Export("bundle")]
  NSBundle Bundle { get; }

  [Export("paletteWillTerminate")] bool PaletteWillTerminate { get; }

  [Export("lastKeyEventWasDeadKey")] bool LastKeyEventWasDeadKey { get; }
}
...
partial interface IMKMouseHandling {
  ...
  bool MouseDown(nuint index, CGPoint point, nuint flags, out bool keepTracking,
                 NSObject sender);
...
partial interface IMKInputController : IMKStateSetting, IMKMouseHandling {
  ...
  NativeHandle Constructor(IMKServer server, NSObject delegateObject,
                           NSObject inputClient);
  ...
  [Export("replacementRange")] NSRange ReplacementRange { get; }

  [Export("markForStyle:atRange:")] NSDictionary Mark(nint style,
                                                      NSRange range);
  ...
  [Export("delegate")] NSObject Delegate { get; set; }

  [Export("server")] IMKServer Server { get; }

  [Export("client")] NSObject Client { get; }

  [Export("inputControllerWillClose")] void InputControllerWillClose();
...
partial interface IMKCandidates {
  ...
  [Export("show:")] void Show(IMKCandidatesLocationHint locationHint);
  ...
  [Export("updateCandidates")] void UpdateCandidates();
  ...
  [Export("candidateFrameTopLeft")] CGPoint CandidateFrameTopLeft { set; }

  [Export("candidateFrame")] CGRect CandidateFrame { get; }

  [Export("selectionKeys")] NSObject[] SelectionKeys { get; set; }

  /* TISInputSourceRef comes from Carbon
  [Export ("selectionKeysKeylayout")]
  TISInputSourceRef SelectionKeysKeylayout { get; set; }*/

  [Export("attributes")] NSDictionary Attributes { get; set; }

  [Export("dismissesAutomatically")] bool DismissesAutomatically { get; set; }

  [Export("selectedCandidate")] nint SelectedCandidate { get; }

  [Export("showChild")] void ShowChild();

  [Export("hideChild")]
  void HideChild();

  [Export("attachChild:toCandidate:type:")]
  void AttachChild(IMKCandidates child, nint candidateIdentifier,
                   IMKStyleType theType);
  ...
  [Export("selectCandidateWithIdentifier:")] bool SelectCandidateWithIdentifier(
      nint candidateIdentifier);
